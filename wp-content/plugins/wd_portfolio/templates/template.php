<?php
function show_wd_portfolio( $columns = 4,$show_filter = "yes", $style="padding", $show_title = "yes" ,$show_desc = "yes", $count = "-1" ){
?>
						<div id="portfolio-container" class="<?php echo esc_attr($style); ?>">
								...
								<div class="portfolio-galleries" id="portfolio-galleries">
									...
									<?php	
										...
										if(have_posts()) : while(have_posts()) : the_post(); global $post;global $wp_query;
											...
											$div_pos = $count % 3;
										?>
										<?php $class_span = 'span'.(24 / $columns);?>
													...
													<div class="thumbnail">	
														<div class="thumb-image post-item ">
															...
															<div class="hover-default thumb-image-hover">
																...
																<div class="icons">
																	<a class="zoom-gallery wd_pretty_photo thumb-image <?php echo $light_box_class;?>" title="<?php _e("View Portfolio","wpdance"); ?>" rel="wd_pretty_photo['<?php echo $light_box_class;?>']" href="<?php echo esc_url($light_box_url);?>"></a>
